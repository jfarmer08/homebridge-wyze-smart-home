...
module.exports = class WyzeThermostat extends WyzeAccessory {
    constructor (plugin, homeKitAccessory) {
      super(plugin, homeKitAccessory)
        ...
        // do setup code here
        this.setThermostatCharacteristics()
    ...
    updateCharacteristics (device) {
        ...
        // off, heat, cool, auto
        this.getTargetHeatingCoolingStateCharacteristic().updateValue(Wyze2HomekitStates.find(device.device_params.mode_sys));

        this.getCurrentHeatingCoolingStatCharacteristic().updateValue(Wyze2HomekitWorkingStates.find(device.device_params.working_state))
        ...
        this.getTemperatureDisplayUnitsCharacteristic().updateValue(this.Wyze2HomekitUnits.find(device.device_params.temp_unit))
    }

    getTargetTemperatureForWorkingState (device) {
        let s = Wyze2HomekitWorkingStates.find(device.device_params.working_state)
